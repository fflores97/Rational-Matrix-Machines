...
function [x, data_1,data_2,true_value_1,true_value_2] = generate_data_with_poles(vector_of_poles, vector_of_residues, relative_width_of_poles, number_points_per_pole, signal_to_noise_ratio)
...
% signal_to_noise_ratio = 1e-3;
  ...
  vector_of_residues = reshape(vector_of_residues, [number_of_poles,2]);
